        ...
        <div className="navbar fixed z-10 md:px-[100px] bg-white">
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <NavLink className={({ isActive }) => isActive ? 'mr-4 px-[20px] py-[15px] text-[18px] font-semibold text-[#23BE0A] rounded-lg border border-[#23BE0A]' : 'mr-4 px-[20px] py-[15px] text-[18px] font-semibold hover:border hover:text-[#23BE0A] rounded-lg hover:border-[#23BE0A]'} to='/aboutus'>About Us</NavLink>
